...
export const ru: Translations = {
  ...
  toolDescriptions: {
    ...
    controlcenter_find_capability: {
      title: "Найти кандидатов, связанных с разрешением",
      description: "Ранжирует заявления о нативной привязке из согласованного по хешу разрешения System Explorer. Происхождение не проверено; результаты рекомендательные и не разрешают выполнение."
    },
    controlcenter_tool_overview: {
      title: "Показать обзор, связанный с разрешением",
      description: "Показывает заявления о нативной привязке и раздельные состояния: заявлен, установлен, настроен, запущен, исправен и наблюдался."
    },
    ...
    controlcenter_find_skill: {
      ...
      description: "Определяет, какие skills подходят к задаче или намерению. ВАЖНО: запрашивайте ключевыми словами и специальными терминами, а не целыми предложениями — сопоставление чисто лексическое, целые предложения пока не понимаются семантически и притягивают ложные совпадения через служебные слова. Ранжирует просканированный каталог skills по лексическому совпадению по имени, алиасам, тегам, категории и описанию и возвращает лучших кандидатов с совпавшими терминами. Оценки сопоставимы только внутри одного запроса, но не между запросами."
    },
