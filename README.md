...
| `INV-GOV-08` | **Read-Only Host Governance Federation** | Mirrors pending decisions, policies, strategic plans, and BYUM metadata read-only. | Strict scalar projection; never adopts, executes, mutates, or silences items. |
