...
- Redact forwarded results recursively, at every nesting level, before they reach the caller's context. Two signals: object keys that name a secret (`token`, `apiKey`, `password`, `cookie`, `private_key`, …) have their value replaced whole, and high-specificity credential shapes inside free text (`sk-…`, `ghp_…`, `github_pat_…`, `AKIA…`, `xox[baprs]-…`, JWTs, `AIza…`) are replaced in place.
